...
The second commonest cause of death is cancer at 10 million. And then we go to the respiratory
diseases at just under four million. And you would notice that infectious diseases, which
are the more prevalent causes in low-income countries, tuberculosis, just over a million
deaths annually, and AIDS just under 900,000. The point to emphasize is that in South Africa,
as in many low- and middle-income countries, has a double burden of disease. On the one hand,
infectious diseases, and on the other, diseases of lifestyle or non-communicable diseases,
which are becoming highly prevalent in middle and low-income countries. Just to put things in
perspective, even during the COVID era, which accounted for a marked increase in global mortality,
if you take statistics done at the end of 2021, ischemic heart disease even in the COVID era accounted
for over 15 million deaths, followed by stroke, which constitutes part of cardiovascular diseases,
accounting for just under 11% of deaths, and COVID-19 at just under 10%. So even in the COVID era,
cardiovascular diseases remained the commonest cause of global mortality.
A coronary artery disease is also known as ischemic heart disease, and amongst the cardiovascular diseases,
coronary artery disease is the leading cause of death globally, individually responsible for 16%
of total deaths. Not only is coronary artery disease the commonest cause of death, the most lethal
manifestation of coronary artery disease is heart attacks, or what we term myocardial infarction,
and which is a medical emergency. What's important to know is that coronary artery disease is a
disease of lifestyle that can be modified, either by choices you make
...
It is the ST segment that really helps us when we try to make a diagnosis of coronary artery disease.
This top ECG shows that this ST segment is isoelectric with the baseline. This is normal.
If the baseline is here and the ST segment is depressed, and here we can see depressed by one,
two, three little small squares, and it's horizontal ST depression. So any depression
in excess of one millimeter, and especially if it's horizontal, that is highly suggestive
of underlying coronary obstruction. But the most important and ominous is ST elevation,
because ST elevation myocardial infarction is a medical emergency, where the myocyte is under
threat, and after five minutes, if there is no blood supply and oxygen delivery, the myocyte
and myocytes begin to die. So ST segment elevation and especially convex ST elevation.
In the limb leads, limb leads are leads one, two, three, AVR, AVL, AVF. All you need is one millimeter.
That means one little small square above the baseline or in the pre-chordial leads,
meaning the chest leads, we want to be six. There's more than two millimeter ST segment
concave elevation. That is highly suggestive of an ST elevation myocardial infarction
which is, as I said, a medical emergency. So again, this is a R-rave, an ST elevation that is
earlier on, and later on, the R-rave is completely lost and you get a deep QA
and residual ST elevation. So when we see deep QAves, we know that that part of the heart
has completely infected and the ST elevation is just a residual
change that you see once the vessel is completely occluded.
This is an ECG of somebody who is having an anterior ST elevation myocardial infarction.
We see ST elevation in leads V1, V2, V3, V4. This pattern of ST elevation is called tombstock.
It looks like a tom
...
choice, you go for tenectoplase first, then autoplase, then stiptokinase. But any fibranolutic agent,
given timelessly, is better than nothing. Coupled with the fibranolutic agent that dissolves the
hummus, you have to use additional anti-thrombotic therapy in STEMI. You use two anti-platelet agents.
You give aspirin an entire tablet to chew. Why to chew? Because it's rapid absorption. And then
aspirin indefinitely for life at a dose of approximately 100 milligrams a day.
In the setting of STEMI, you have to give a second anti-platelet agent. And in our
state facility, we have clopidic realm. You give a loading dose of 300 milligrams, followed by 75
milligrams a day. And this dual anti-platelet therapy is given for one year, meaning both
anti-platelet drugs are given for one year. At the end of one year, clopidic realm is generally
stopped, but aspirin is continued for life. In the acute setting, not only do we give the
fibranolutic agent, plus the anti-platelet, two anti-platelet agents, we also give an anti-thumbin.
And we either give enoxyparin or heparin. Not both yet. It's either enoxyparin or heparin.
Enoxyparin is preferred because it's given sub-initially in STEMI as an IV stat, followed by sub-cut 12
only. It's preferred because of the sub-cut ease of administration, whereas heparin is given as
continuous intravenous infusion. And heparin has to be monitored, so it makes it a bit more cumbersome.
But if you have nothing else, you will use heparin. So to recap, fibranolutic agent,
plus two anti-platelet agents, plus either enoxyparin or heparin. That is a minimum of four
agents, of four anti-thumbotic agents to rise the clot and maintain vessel patency in all patients
with step. What we mean by a percutaneous coronary interventio
...
We work at the general axis of current.
And then we're going to look at each wave specifically and look at any abnormalities of morphology.
We look for any evidence of chamber dilatation and chamber hypertrophy that is evident on the ECG.
We'll then go through the stages of myocardial infarction on the ECG in any metabolic conditions that can affect your ECG tracing.
In terms of calibration, on the x-axis, you get that's a measure of time, which is measured in milliseconds.
The paper speed must be set at 25 millimeters per second so that each millimeter is 0.04 seconds or 40 milliseconds.
On the y-axis, that is amplitude or voltage, and every 10 millimeters is equivalent to 1 millivolts.
You then have to make sure that your electrodes are placed correctly.
We place 10 electrodes, which gives us 12 leads on the ECG.
First, we look at the limb leads, which are lead 1, lead 2, and lead 3.
Then there's the augmented limb leads, which are AVR, AVL, and AVF.
So each electrode is placed on the right arm, the left arm, and the left leg.
Then there's the pre-chordial leads, which are placed across the chest.
V1 is in the fourth intercostal space in the right-parastormal area.
V2 in the fourth intercostal space in the left-parastormal area.
V4 is in the fifth intercostal space in the metallivicular line, and V3 is placed between V2 and V4.
V6 is in the fifth intercostal space in the metoxillary line, and V5 is placed between V4 and V6.
The reason that you have 10 electrodes, but you get 12 leads, is because the standard limb leads,
1, 2, and lead 3 are bipolar leads, which means that they read the current measures between
two different electrodes.
So lead 1 reads between the
...
infection. It is a diffuse inflammatory disease of connective tissue and it primarily involves
the heart, the blood vessels, the joints, the subcutaneous tissue, and the central nervous system.
In terms of the pathogenesis, it's a delayed immune response to infection with group A,
beta-homolytic streptococcal. You usually have a latent period which usually lasts about one
to three weeks. You have an antibody induced immunological damage which occurs to be heart
valves, the joints, the subcutaneous tissue, and basal ganglia of the brain.
To diagnose rheumatic fever, we use the modified Jones criteria and that is divided into major
and minor criteria. The major criteria includes a carditis and that this is a pan carditis,
so it affects the pericardium, the myocardium, and the endocardium. You also have a polyarthritis.
This is typically described as a flitting arthritis, so it normally affects one joint and then progresses
to involve adjacent joints. There's also the presence of subcutaneous nodules, erythema
margenatum, and sydnam's career. The minor criteria include the presence of a fever,
arthralgia, elevated ESR and C-reactive protein, the presence of a leukocytosis,
and a prolonged PR interval on your ECG. A prolonged PR interval on the ECG may also indicate
a possible root abscess. We also look for supporting evidence of streptococcal infection,
and this includes increased teetres of antistreptococcal antibodies,
your ASOT and your anti-DNA's. We look for the presence of a positive throat culture for group
A streptococcal and the presence of recent scarlet fever. In terms of treatment,
we look at
...
and the heart valves are most commonly affected. Patients may also develop a central defect
on the mural endocardium. It's virtually always paper if untreated.
Regarding the classification, there are four categories, different infecting organisms
and they run different courses. This may involve the native valve, protein native valve endocarditis,
prosthetic valve endocarditis, endocarditis that is seen in intravenous drug abuses as well as
nosocomial endocarditis. It may also be classified as either acute or subacute.
In acute infective endocarditis, this results in marked toxicity, progresses over days to several
weeks, and results in valvular destruction as well as metastatic infection. The usual organism
here is staphylococcus aureus and if this is untreated, it is fatal in less than six weeks.
In subacute infective endocarditis, this tends to evolve over weeks to months with modest toxicity.
The usual organism here is streptococcus very dense and this really causes metastatic
fossa. Again, if this is untreated, it will be fatal but it usually takes longer than six weeks
compared to acute infective endocarditis.
Just coming to the epidemiology, the annual incidence is about 15 to 20,000 cases per year.
It's the fourth kneeling cause of life-threatening infectious disease
with a slight predeliction for males with a ratio of 1.7 to 1. In up to 45% of cases, it involves
a mitral valve and the aortic in 36%. This slide highlights the different etiological agents
and as you can see, the streptococcus group makes up the majority of cases up to 80%.
Staphylococcus about 20 to 35% and the gram-negative aerobic bacilli
much less percentage up to abou
...
Mechanisms
Neural – sympathetic overactivity
Baroreceptor dysfunction
Obesity related
Obstructive sleep apnoea – increased catecholamines
...
GFR <60ml/min
Acute Kidney diseases – any acute insult
Chronic Kidney disease
Various causes of CKD
...
Heart failure, ventricular tachyarrythmias, atrial fibrillation
Myocyte hypertrophy, collagen desposition,  myocardial fibrosis
CNS
ischeamic stroke
...
Rich in fruit, vegeatables, low fat dairy products, reduced saturated and total fat
...
2. ACE inhibitor or ARB blocker
Enalapril or Lorsartan
...
Unstable 	Non-Q		Q-Waveangina		   AMI		    AMI
ECG
AcuteReperfusion
HistoryPhysical Exam
...
AV block occurs due to failure of AV node to conduct every impulse
...
The lifetime risk of developing CAD in men and women after 40 years of age is 49% and 32%, respectively
Gender: Men are at increased risk compared to women
Ethnicity: Southeast Asians are at an increased risk
Family history:
...
CCS
ACS
Pathology of Atherosclerotic CAD
[NOTES]
...
Diagnosis
Clinical : angina is a diagnosis made on history
12 Lead ECG
Stress Tests
Exercise stress, Pharmacological stress, Nuclear stress
Imaging
...
ECG changes
The most important ECG change is ST segment deviation:
either elevation or depression of at least 1 mm in leads without a
diagnostic Q wave)
DIAGNOSIS :  Exercise Stress Testing
...
Clopidogrel: a P2Y12  ADP receptor antagonist if unable to tolerate Aspirin
Lipid lowering agents
Statins, Ezetimibe, PCSK 9 inhibitors
Beta blockers
Secondary prevention in post MI patients
...
ASA + Clopidogrel | All-cause death | 0.79
ASA + Ticagrelor | All-cause death | 0.68 – 0.89
ASA + Low-dose Rivaroxaban | MI, stroke or CV death | 0.74
Ramipril | MI, stroke, CV death | 0.78
Perindopril | MI, cardiac arrest, CV death | 0.80
Telmisartan | All-
...
+
ECG  STE  >  1 mm in limb leads
>  2 mm in precordial lead
(or new  LBBB)
REPERFUSION
[NOTES]
...
Streptokinase
1.5 million units as an infusion over one hour
Alteplase
100 mg total dose infused over 1.5 hr
15 mg IV bolus over 1-2 minutes,
then 50 mg IV infusion over next 30 minutes
then remaining 35 mg over next 60 minutes
Tenectaplase
0.53 mg/kg IV bolus over 5 seconds
[NOTES]
Quotation price of alteplase 100mg: R 11 830.88, 29 January 2019 .
...
Anaemia (unrecognized GI bleeding)
COPD acute exarcerbation
...
NSTE ACS
The ischaemia is severe enough to cause myocardial n
...
Strong relationship between the level of risk and prognosis
...
Impaired LV function: S3, crackles, pulmonary oedema, EF < 40%
Advanced elderly > 75 years
ECG
ST depression or transient elevation
Bundle branch block or tachyarrhythmias
Biomarkers
Troponin elevation
...
General
Bedrest
Oxygen, maintain arterial saturation > 90%
Specific
Anti-ischaemic
Anti-platelet
Anti-thrombins
...
Retrosternal
Sharp in nature
Worse on inspiration and in the supine position
...
Filling volume of the ventricular diastole decreases
...
Filling in early diastole is unimpaired
...
- ECG interpretation and diagnostic criteria
- Valvular heart disease and pathophysiology
- Infective endocarditis: epidemiology, diagnosis, management
- Hypertension: epidemiology and clinical management
- Pericardial disease and related conditions
