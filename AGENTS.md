...
- **mccqe1 syllabus**: 31 discipline subjects imported via `node scripts/import_mccqe1.js`; no triage scenarios; active mccqe1 eager-fetches ~32MB at boot (default cmed4-2026 ~2MB unaffected). Import classifier, shard shapes, perf detail + lazy-split future work: recall "corpus mccqe1 syllabus import detail".
